            ...
            for line in order.order_line:
                for _access_package in ap_ids:
                    if line.product_id in _access_package.products:
                        self.sudo().env['climbing_gym.member_access_package'].create_access_package(self, line,
                                                                                                    _access_package)
            ...
            for line in order.order_line:
                for _membership_package in mp_ids:
                    if line.product_id in _membership_package.products:
                        self.sudo().env['climbing_gym.member_membership_package'].create_membership_package(self, line,
                                                                                                            _membership_package)
